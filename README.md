...
Built on [Academic Pages](https://github.com/academicpages/academicpages.github.io) (Jekyll + Minimal Mistakes), hosted free on GitHub Pages.

- Content lives in `_pages/`, `_publications/`, `_teaching/`, `_portfolio/`, `_data/`
